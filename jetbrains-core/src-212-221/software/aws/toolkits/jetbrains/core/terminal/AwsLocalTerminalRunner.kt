...
class AwsLocalTerminalRunner(project: Project, private val termName: String, private val applyConnection: (MutableMap<String, String>) -> Unit) : LocalTerminalDirectRunner(project) {
