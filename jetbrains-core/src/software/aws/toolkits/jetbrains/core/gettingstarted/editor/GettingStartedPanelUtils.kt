...
fun getSourceOfEntry(sourceOfEntry: SourceOfEntry, isStartup: Boolean = false): String {
    val source = if(isStartup) SourceOfEntry.FIRST_STARTUP.name else sourceOfEntry.name
