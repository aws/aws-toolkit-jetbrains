...
class GettingStartedVirtualFile(val firstInstance: Boolean, val connectionInitiatedFromExplorer : Boolean = false) : LightVirtualFile(message("gettingstarted.editor.title")) {
