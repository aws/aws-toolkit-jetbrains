...
import software.aws.toolkits.jetbrains.settings.DefaultAwsSettings
...
class AwsTelemetryPrompter : StartupActivity {
    ...
    override fun runActivity(project: Project) {
        if (!DefaultAwsSettings.getInstance().promptedForTelemetry) {
            ...
            DefaultAwsSettings.getInstance().promptedForTelemetry = true
        }
    }
}