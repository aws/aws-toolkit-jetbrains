...
class DefaultTelemetryService(settings: AwsSettings, private val batcher: TelemetryBatcher = DefaultToolkitTelemetryBatcher()) : TelemetryService, TelemetryEnabledChangedNotifier {
