...
class DownloadObjectAction(private val project: Project, treeTable: S3TreeTable) : S3ObjectAction(treeTable, message("s3.download.object.action"), AllIcons.Actions.Download) {
