...
enum class RuntimeGroup {
    ...
    fun supportSamBuild(): Boolean = info.asSequence().all { it.supportSamBuild() }
...
interface RuntimeGroupInformation {
    ...
    /**
     * Whether this runtime group support SAM build so that SAM template with runtimes of this type could be deployed to AWS.
     */
    fun supportSamBuild(): Boolean
...
abstract class SdkBasedRuntimeGroupInformation : RuntimeGroupInformation {
    ...
    override fun supportSamBuild(): Boolean = false
}
