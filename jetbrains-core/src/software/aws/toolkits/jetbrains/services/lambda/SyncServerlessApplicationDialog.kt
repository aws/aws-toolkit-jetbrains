...
class SyncServerlessApplicationDialog(project: Project, private val templateFile: VirtualFile,): DialogWrapper(project) {
    ...
    private val component by lazy {
        panel{
            buttonsGroup {
                row {
                    radioButton("Create Stack  ").applyToComponent {
                        ...
                        stackName2.isEnabled = component.isSelected
                    }
            ...
            val parametersField = KeyValueTextField()
    ...
    init {
        super.init()
        title = "Sync Serverless Application"
        setOKButtonText("Sync")
    }
}

data class SyncSamSettings(
    val stackName: String,
    val s3BucketName: String?,
    val ecrRepoName: String?,
...
/*class SyncServerlessApplicationDialog(
    ...
    internal fun buildPanel() =
        com.intellij.ui.layout.panel {
            ...
            // ecr repo
            val ecrSelectorPanel = com.intellij.ui.layout.panel {
