...
fun notifyInfo(title: String, content: String = "", project: Project? = null, action: AnAction) =
    notify(Notification(GROUP_DISPLAY_ID, title, content, NotificationType.INFORMATION).addAction(action), project)
