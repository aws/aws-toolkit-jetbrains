...
""")
    ...
    @Test
    fun notDeployable_unknownTemplateFile() {
...
""")
        ...
        runInEdtAndWait {
            val path = "/foo/path/template.yaml"
            assertThat(projectRule.project.validateSamTemplateLambdaRuntimes(path)).isEqualTo(message("serverless.application.deploy.error.no_functions_defined", path))
        }
    }
