...
class CawsHostCommandExecutor private constructor(private val delegate: HostCommandExecutor) : HostCommandExecutor by delegate {
    constructor(creds: RemoteCredentials) : this(SshCommandExecutor(creds, useSftp = false, allowDialogs = true))
    ...
    override suspend fun executeCommand(
        ...
        val streams = delegate.executeCommand(lifetime, command = command, mergeStderrIntoStdout, false)
