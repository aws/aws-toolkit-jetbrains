...
namespace JetBrains.UI.ThemedIcons
{
	...
	public sealed class LambdaRunMarkersThemedIcons
	{
		...
		/// <summary>
		///	<para>
		///		<para>Lambda Themed Icon generated identifiers:</para>
		///		<para>— <see cref="Lambda"></see> identifier class, for use in attributes, XAML, and generic parameters;</para>
		///		<para>— <see cref="Id"></see> identifier object, as a field in the identifier class, for use where an <see cref="JetBrains.UI.Icons.IconId"></see> value is expected.</para>
		///		<para>
		///			<code>
		///          "{a1_    '(a5^
		...
		///</remarks>
		///<example>
		///	<code>&lt;Image Source="{icons:ThemedIcon myres:PohequkThemedIconsThemedIcons+Lambda}" /&gt;        &lt;!-- XAML --&gt;</code>
		///</example>
		///<example>
		///	<code>[Item(Name="Sample", Icon=typeof(PohequkThemedIconsThemedIcons.Lambda))]        // C# Type attribute</code>
		///</example>
		///<example>
		///	<code>IconId iconid = PohequkThemedIconsThemedIcons.Lambda.Id;        // IconId identifier object</code>
		///</example>
		///<example>
		///	<code>themediconmanager.GetIcon&lt;PohequkThemedIconsThemedIcons.Lambda&gt;()        // Icon image for rendering</code>
		///</example>
		[global::JetBrains.Application.Icons.CompiledIconsCs.CompiledIconCsAttribute()]
		...
		/// <summary>
		///	<para>
		///		<para>CreateNew Themed Icon generated identifiers:</para>
		///		<para>— <see cref="CreateNew"></see> identifier class, for use in attributes, XAML, and generic parameters;</para>
		///		<para>— <see cref="Id"></see> identifier object, as a field in the identifier class, for use where an <see cref="JetBrains.UI.Icons.IconId"></see> value is expected.</para>
		///		<para>
		///			<code>
		///          "{a1_    '(a5^
		...
		///</remarks>
		///<example>
		///	<code>&lt;Image Source="{icons:ThemedIcon myres:PohequkThemedIconsThemedIcons+CreateNew}" /&gt;        &lt;!-- XAML --&gt;</code>
		///</example>
		///<example>
		///	<code>[Item(Name="Sample", Icon=typeof(PohequkThemedIconsThemedIcons.CreateNew))]        // C# Type attribute</code>
		///</example>
		///<example>
		///	<code>IconId iconid = PohequkThemedIconsThemedIcons.CreateNew.Id;        // IconId identifier object</code>
		///</example>
		///<example>
		///	<code>themediconmanager.GetIcon&lt;PohequkThemedIconsThemedIcons.CreateNew&gt;()        // Icon image for rendering</code>
		///</example>
		[global::JetBrains.Application.Icons.CompiledIconsCs.CompiledIconCsAttribute()]
