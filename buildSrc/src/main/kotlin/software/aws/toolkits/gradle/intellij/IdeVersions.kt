...
object IdeVersions {
    ...
    private val ideProfiles = listOf(
        ...
        Profile(
            ...
            gateway = ProductProfile(
                sdkFlavor = IdeFlavor.GW,
                sdkVersion = "241.8102-EAP-CANDIDATE-SNAPSHOT",
                plugins = arrayOf("org.jetbrains.plugins.terminal")
            ),
            community = ProductProfile(
                sdkFlavor = IdeFlavor.IC,
            ...
            ultimate = ProductProfile(
                ...
                plugins = commonPlugins + listOf(
                    ...
                    "com.intellij.database",
                    "com.jetbrains.codeWithMe",
                    "Pythonid:241.8102.112",
                    "org.jetbrains.plugins.go:241.8102.112",
                    // https://github.com/JetBrains/gradle-intellij-plugin/issues/1056
                    "org.intellij.intelliLang"
                )
            ),
            rider = RiderProfile(
                sdkVersion = "2024.1-EAP1-SNAPSHOT",
                plugins = commonPlugins + listOf(
                    "rider-plugins-appender" // Workaround for https://youtrack.jetbrains.com/issue/IDEA-179607
                ),
                netFrameworkTarget = "net472",
                rdGenVersion = "2024.1.0-pre1",
                nugetVersion = "2024.1.0-eap01"
            )
        ),
