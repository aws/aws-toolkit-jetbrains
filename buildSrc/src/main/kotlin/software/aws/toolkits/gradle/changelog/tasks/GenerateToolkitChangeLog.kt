...
// TODO(repo-split): Toolkit repo keeps these classes

open class GenerateToolkitPluginChangeLog : ToolkitChangeLogTask() {
    @Input
    @Optional
...
open class GenerateToolkitGithubChangeLog : ToolkitChangeLogTask() {
    @Input
    @Optional
    val repoUrl: Provider<String?> = project.objects.property(String::class.java).convention("https://github.com/aws/aws-toolkit-jetbrains")
