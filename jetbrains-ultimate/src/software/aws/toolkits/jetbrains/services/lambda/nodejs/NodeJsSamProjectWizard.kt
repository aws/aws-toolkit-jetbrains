...
class SamHelloWorldNodeJs : SamAppTemplateBased() {
    ...
    override fun supportedZipRuntimes(): Set<LambdaRuntime> = setOf(LambdaRuntime.NODEJS12_X, LambdaRuntime.NODEJS14_X, LambdaRuntime.NODEJS16_X, LambdaRuntime.NODEJS18_X)

    override fun supportedImageRuntimes(): Set<LambdaRuntime> = setOf(LambdaRuntime.NODEJS12_X, LambdaRuntime.NODEJS14_X, LambdaRuntime.NODEJS16_X, LambdaRuntime.NODEJS18_X)
