...
typealias CredentialManager = migration.software.amazon.q.jetbrains.core.credentials.CredentialManager
...
class DefaultCredentialManager : CredentialManager(), Disposable {
    ...
    companion object {
        val EP_NAME = ExtensionPointName.create<CredentialProviderFactory>("amazon.q.credentialProviderFactory")
