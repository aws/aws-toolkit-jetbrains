...
fun findWorkspaceContentRoots(): Set<VirtualFile> {
 ...
 * @param changeListManagers The VCS change list managers which will be checked for ignored files
 * @param additionalIgnoreTests Additional ignore rules to enforce
 */
fun isWorkspaceSourceContent(
    path: VirtualFile,
    contentRoots: Set<VirtualFile>,
    changeListManagers: Iterable<ChangeListManager>,
    ...
    return !changeListManagers.any { it.isIgnoredFile(path) }
}
