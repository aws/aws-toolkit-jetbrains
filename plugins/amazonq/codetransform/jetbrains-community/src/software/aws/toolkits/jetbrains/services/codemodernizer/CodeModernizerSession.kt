...
class CodeModernizerSession(
    ...
    fun tryOpenTransformationPlanEditor() {
        ...
        val step0Update0 = TransformationProgressUpdate.builder().name("Job statistics").status("COMPLETED").description("{\"columnNames\":[\"Name\",\"Value\"],\"rows\":[{\"Name\":\"Lines of code in your application\",\"Value\":\"3000\"},{\"Name\":\"Dependencies to be replaced\",\"Value\":\"5\"},{\"Name\":\"Deprecated code instances to be replaced\",\"Value\":\"10\"},{\"Name\":\"Files to be updated\",\"Value\":\"7\"}]}").build()
        val step0Update1 = TransformationProgressUpdate.builder().name("Dependency changes (2)").status("COMPLETED").description("{\"columnNames\":[\"Dependency\",\"Action\",\"Current version\",\"Target version\"],\"rows\":[{\"Dependency\":\"org.springboot.com\",\"Action\":\"Update\",\"Current version\":\"2.1\",\"Target version\":\"2.4\"}, {\"Dependency\":\"com.lombok.java\",\"Action\":\"Remove\",\"Current version\":\"1.7\",\"Target version\":\"-\"}, {\"Dependency\":\"org.springboot.com\",\"Action\":\"Update\",\"Current version\":\"2.1\",\"Target version\":\"2.4\"}, {\"Dependency\":\"org.springboot.com\",\"Action\":\"Update\",\"Current version\":\"2.1\",\"Target version\":\"2.4\"}, {\"Dependency\":\"org.springboot.com\",\"Action\":\"Update\",\"Current version\":\"2.1\",\"Target version\":\"2.4\"}, {\"Dependency\":\"org.springboot.com\",\"Action\":\"Update\",\"Current version\":\"2.1\",\"Target version\":\"2.4\"}]}").build()
        val step0Update2 = TransformationProgressUpdate.builder().name("Deprecated code changes (2)").status("COMPLETED").description("{\"columnNames\":[\"Deprecated code\",\"Suggested replacement\",\"Files to be changed\"],\"rows\":[{\"Deprecated code\":\"java.lang.Thread.stop()\",\"Suggested replacement\":\"java.lang.Thread.alternative()\",\"Files to be changed\":\"6\"}, {\"Deprecated code\":\"java.math.bad()\",\"Suggested replacement\":\"java.math.good()\",\"Files to be changed\":\"3\"}]}").build()
        val step0Update3 = TransformationProgressUpdate.builder().name("Files to be changed (2)").status("COMPLETED").description("{\"columnNames\":[\"File name\",\"Action\"],\"rows\":[{\"File name\":\"pom.xml\",\"Action\":\"Update\"}, {\"File name\":\"src/main/java/com/bhoruka/bloodbank/BloodbankApplication.java\",\"Action\":\"Update\"}]}").build()
        val step0 = TransformationStep.builder().id("0_SupplementInfo").name("Supplemental info").description("Supplemental info").status("COMPLETED").progressUpdates(listOf(step0Update0, step0Update1, step0Update2, step0Update3)).build()
        val step1 = TransformationStep.builder().id("1_OpenRewriteAndPythonDepKnowledge_V1").name("Step 1: Update JDK version, dependencies, and related code").description("Amazon Q will attempt to update the JDK version and change the following dependencies and related code.").status("COMPLETED").build()
        val step2 = TransformationStep.builder().id("2_UpdateDeprecatedAPI").name("Step 2: Update deprecated code").description("Amazon Q will attempt to replace the following instances of deprecated code.").status("COMPLETED").build()
        val step3 = TransformationStep.builder().id("3_PythonErrorsKnowledgeAndLlmDebugPom_V1").name("Step 3: Build in Java 17 and fix any issues").description("Amazon Q will build the upgraded code in Java 17 and iteratively fix any build errors encountered.").status("COMPLETED").build()
        val step4 = TransformationStep.builder().id("4_PassThroughValidation_V2").name("Step 4: Finalize code changes and generate transformation summary").description("Amazon Q will generate code changes for you to review and accept. It will also summarize the changes made and will copy over build logs for future reference and troubleshooting.").status("COMPLETED").build()
        val transformationPlan = TransformationPlan.builder().transformationSteps(listOf(step0, step1, step2, step3, step4)).build()
