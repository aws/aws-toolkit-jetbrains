...
class DefaultAwsConnectionManager(project: Project) :
    ...
    override fun loadState(state: ConnectionSettingsState) {
        ...
        coroutineScope.launch {
            ...
            val regionId = state.activeRegion ?: credentials?.defaultRegionId ?: AwsRegionProvider.Companion.getInstance().defaultRegion().id
            val region = AwsRegionProvider.Companion.getInstance().allRegions()[regionId]
