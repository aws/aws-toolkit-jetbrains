...
/**
 * Generic utility for migrating component state from aws.xml to awsToolkit.xml.
 * Handles all XML parsing internally and returns properly typed state objects.
 */
object ToolkitSettingsMigrationUtil {
    private val LOG = Logger.getInstance(ToolkitSettingsMigrationUtil::class.java)

    // Mapping of old component names to new component names
    private val COMPONENT_NAME_MAPPINGS = mapOf(
        "aws" to "toolkit",
        "accountSettings" to "toolkitAccountSettings",
        "authManager" to "toolkitAuthManager",
        "connectionManager" to "toolkitConnectionManager",
        "connectionPinningManager" to "toolkitConnectionPinningManager",
        "notificationDismissals" to "toolkitNotificationDismissals",
        "notificationEtag" to "toolkitNotificationEtag",
        "toolkitExecutables" to "toolkitExecutables",
        "toolkitExperiments" to "toolkitExperiments",
        "toolkitExplorerToolWindow" to "toolkitExplorerToolWindow",
        "toolkitTools" to "toolkitTools",
        "toolkitCawsSpace" to "toolkitCawsSpace",
        "toolkitResources" to "toolkitResources",
        "toolkitEcsExec" to "toolkitEcsExec",
        "toolkitGettingStarted" to "toolkitGettingStarted",
        "toolkitLambda" to "toolkitLambda",
        "toolkitSamAccDevMode" to "toolkitSamAccDevMode",
        "toolkitUpdateLambdaState" to "toolkitUpdateLambdaState"
    )
     ...
     *
     * @param newComponentName The new component name (e.g., "toolkitAccountSettings")
