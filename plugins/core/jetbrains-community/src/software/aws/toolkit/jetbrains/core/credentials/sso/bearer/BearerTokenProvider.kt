...
import software.aws.toolkit.core.credentials.ToolkitBearerTokenProviderDelegate
...
import software.aws.toolkit.jetbrains.core.credentials.sso.AccessToken
...
import software.aws.toolkit.jetbrains.core.credentials.sso.SsoAccessTokenProvider
        ...
        fun refresh(): AccessToken {
            ...
            return try {
                accessTokenProvider.refreshToken(lastToken).also {
                    ...
                    ApplicationManager.getApplication().messageBus.syncPublisher(BearerTokenProviderListener.Companion.TOPIC).onTokenModified(id)
                }
...
fun buildUnmanagedSsoOidcClient(region: String): SsoOidcClient =
    AwsClientManager.Companion.getInstance()
