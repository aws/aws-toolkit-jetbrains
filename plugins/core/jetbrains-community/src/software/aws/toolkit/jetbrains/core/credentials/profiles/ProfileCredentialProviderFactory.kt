...
import software.aws.toolkit.jetbrains.core.credentials.InteractiveCredential
import software.aws.toolkit.jetbrains.core.credentials.MfaRequiredInteractiveCredentials
import software.aws.toolkit.jetbrains.core.credentials.PostValidateInteractiveCredential
import software.aws.toolkit.jetbrains.core.credentials.ReauthSource
import software.aws.toolkit.jetbrains.core.credentials.RefreshConnectionAction
import software.aws.toolkit.jetbrains.core.credentials.SsoRequiredInteractiveCredentials
...
import software.aws.toolkit.jetbrains.core.credentials.diskCache
import software.aws.toolkit.jetbrains.core.credentials.profiles.Ec2MetadataConfigProvider.getEc2MedataEndpoint
import software.aws.toolkit.jetbrains.core.credentials.reauthConnectionIfNeeded
import software.aws.toolkit.jetbrains.core.credentials.sso.SsoCache
...
import software.aws.toolkit.core.credentials.SsoSessionBackedCredentialIdentifier
...
import software.aws.toolkit.jetbrains.core.credentials.profiles.SsoSessionConstants.PROFILE_SSO_SESSION_PROPERTY
...
class ProfileCredentialsIdentifierSso @TestOnly constructor(
    ...
    override val sessionIdentifier = "${SsoSessionConstants.SSO_SESSION_SECTION_NAME}:$ssoSessionName"
            ...
            notifyError(
                ...
                notificationActions = listOf(
                    createNotificationExpiringAction(
                        ActionManager.getInstance().getAction("aws.toolkit.settings.upsertCredentials")
                    ),
                ...
                notifyInfo(
                    ...
                    notificationActions = listOf(
                        ...
                        createShowMoreInfoDialogAction(
                            AwsCoreBundle.message("credentials.invalid.more_info"),
                            errorDialogTitle,
                            numErrorMessage,
                            message
                        )
