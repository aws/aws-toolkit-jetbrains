...
import software.aws.toolkit.core.telemetry.CachedIdentityStorage
...
class AwsCognitoCredentialsProviderTest {
    ...
    fun testGetCredentialsExpired() {
        ...
        verify(cognitoClient, timeout(5_000).times(2)).getCredentialsForIdentity(getCredentialsRequestCaptor.capture())
    }
