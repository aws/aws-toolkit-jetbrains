...
import software.aws.toolkit.jetbrains.core.dummyResource
...
class RefreshConnectionActionTest {
    ...
    private fun checkExpectedActionState(connectionState: ConnectionState, shouldBeEnabled: Boolean) {
        val mockProjectAccountSettingsManager = MockAwsConnectionManager.Companion.getInstance(projectRule.project)
