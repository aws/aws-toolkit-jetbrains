...
package software.aws.toolkit.core.telemetry
...
class TelemetryBatcherTest {
    ...
    fun testSingleBatch() {
        ...
        batcher.enqueue(DefaultMetricEvent.Companion.builder().build())
        batcher.flush(false)
    ...
    fun verifyCallbackMetricPublished() {
        ...
        val fooMetricEvent = DefaultMetricEvent.Companion.builder()
    ...
    private fun createEmptyMetricEvent(): MetricEvent = DefaultMetricEvent.Companion.builder().build()
